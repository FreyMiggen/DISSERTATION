...
from post.views import index,FunctionNewFeed,searchBar
...
urlpatterns = [
    ...
    path('lostfeed/',FunctionNewFeed.as_view(),{'type':'lost'},name='lostfeed'),
    path('foundfeed/',FunctionNewFeed.as_view(),{'type':'found'},name='foundfeed'),
